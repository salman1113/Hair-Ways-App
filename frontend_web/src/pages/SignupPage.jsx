...
import { Loader2, ArrowRight, ArrowLeft, User, Mail, Lock, Phone, AlertTriangle } from 'lucide-react';
...
const SignupPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white p-4 md:p-0 relative">
      ...
      <div className="w-full max-w-5xl bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row min-h-[600px] md:min-h-[700px] animate-fade-in border border-gray-100">
          ...
          <div className="max-w-md mx-auto w-full">
            ...
            <div style={{
              ...
              <p style={{ margin: 0, fontSize: '11.5px', fontWeight: 600, color: '#9a3412', lineHeight: 1.4 }}>
                🚧 <strong>Maintenance:</strong> We're experiencing a technical issue. Sign up may be unavailable.
              </p>
            </div>
